...
surv_table_display <- data.frame(
  Profile = c(
    "Male",
    "  Average", "  High BP (160)", "  Diabetes", "  High BP + DM", "  Smoker",
    "Female",
    "  Average", "  High BP (160)", "  Diabetes", "  High BP + DM", "  Smoker"
  ),
  Age_40 = c(
    "",
    round(m40[1,1], 4), round(m40[1,2], 4), round(m40[1,3], 4), round(m40[1,4], 4), round(m40[1,5], 4),
    "",
    round(f40[1,1], 4), round(f40[1,2], 4), round(f40[1,3], 4), round(f40[1,4], 4), round(f40[1,5], 4)
  ),
  Age_50 = c(
    "",
    round(m50[1,1], 4), round(m50[1,2], 4), round(m50[1,3], 4), round(m50[1,4], 4), round(m50[1,5], 4),
    "",
    round(f50[1,1], 4), round(f50[1,2], 4), round(f50[1,3], 4), round(f50[1,4], 4), round(f50[1,5], 4)
  ),
  Age_60 = c(
    "",
    round(m60[1,1], 4), round(m60[1,2], 4), round(m60[1,3], 4), round(m60[1,4], 4), round(m60[1,5], 4),
    "",
    round(f60[1,1], 4), round(f60[1,2], 4), round(f60[1,3], 4), round(f60[1,4], 4), round(f60[1,5], 4)
  )
)
...
kable(as_tibble(periods_table),
      caption  = "Risk Factor Comparison Across Data Collection Periods",
      booktabs = TRUE,
      align    = "l",
      table.envir = "table[H]")
